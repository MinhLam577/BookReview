    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
              <button className="flex flex-col items-center justify-center gap-2 p-4 bg-white rounded-2xl border border-black/5 hover:bg-black/5 transition-colors group">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest">Want to Read</span>
              </button>
              <button className="flex flex-col items-center justify-center gap-2 p-4 bg-white rounded-2xl border border-black/5 hover:bg-black/5 transition-colors group">
                <Star className="text-brand-primary/40 group-hover:text-brand-primary transition-colors" />
                <span className="text-[10px] font-bold uppercase tracking-widest">Mark Favorite</span>
              </button>
              <button className="flex flex-col items-center justify-center gap-2 p-4 bg-white rounded-2xl border border-black/5 hover:bg-black/5 transition-colors group">
          ...
          >
            ...
            <div className="flex items-center gap-6 mb-12">
              ...
              <div className="flex items-center gap-2 text-brand-primary/60">
                ...
                <span className="font-bold">{book.reviewCount} Reviews</span>
              </div>
            </div>

            <div className="prose prose-lg max-w-none mb-16">
              <h3 className="text-sm font-bold uppercase tracking-[0.2em] opacity-40 mb-4">Description</h3>
            ...
            <div className="space-y-12">
              <div className="flex items-center justify-between">
                <h2 className="text-3xl font-serif font-bold">Reader Reviews</h2>
                <button
              ...
              {book.reviews.length > 0 ? (
                ...
                <div className="p-12 text-center bg-white rounded-3xl border border-dashed border-black/20">
                  <p className="text-brand-primary/40 italic">No reviews yet. Be the first to share your thoughts!</p>
                </div>
              )}
            </div>
          </motion.div>
      ...
      >
        <form onSubmit={handleSubmitReview} className="space-y-6">
          <div>
            <label className="block text-sm font-bold uppercase tracking-widest opacity-40 mb-3">Your Rating</label>
              ...
              {[1, 2, 3, 4, 5].map((star) => (
                ...
                >
                  <Star 
                    ...
                    className={cn(
                      "transition-colors",
                      (hoverRating || rating) >= star ? "fill-brand-primary text-brand-primary" : "text-brand-primary/10"
                    )} 
                  />
                </button>
              ))}
          ...
          <div>
            <label className="block text-sm font-bold uppercase tracking-widest opacity-40 mb-3">Review Content</label>
            <textarea
              required
              rows={5}
