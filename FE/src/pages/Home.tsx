        ...
        <div className="space-y-24 pb-24">
                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            <h1 className="text-6xl md:text-8xl font-serif font-bold leading-[0.9] tracking-tight mb-8">
                                Discover Your <br />
                                <span className="text-brand-accent/40 italic">
                                    Next Favorite
                                </span>{" "}
                                <br />
                                Book
                            ...
                            <p className="text-lg md:text-xl text-white/60 font-light leading-relaxed mb-12 max-w-xl">
                                Explore thousands of curated reviews, trending
                                titles, and literary gems. LuminaBooks is your
                                refined companion in the world of reading.
                            </p>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    <div>
                        <span className="text-[10px] font-bold uppercase tracking-[0.3em] opacity-40 mb-3 block">
                            Current Trends
                        </span>
                    ...
                    <Link
                        to="/explore"
                        className="text-brand-primary/60 hover:text-brand-primary font-bold flex items-center gap-1 group transition-colors"
                    >
                        See all books
                        <ArrowRight
                            size={16}
            ...
            <section className="bg-white py-24 border-y border-black/5">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
                    <BookOpen
                        className="mx-auto mb-8 text-brand-primary opacity-20"
                        size={48}
                    />
